      ...
      <div style={styles.NFTs}>
        {NFTBalance &&
          NFTBalance.map((nft, index) => (
            ...
            <Card
              ...
              actions={[
                <Tooltip title="View On Opensea">
                  <FileSearchOutlined
                    onClick={() =>
                      window.open("https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/45420177711653843954781376584544552839302508263742502603255103395423389220865", "_blank")
                    }
                  />
                </Tooltip>,
              ]}
            ...
            >
              <Meta title={'Sarangay'} description={'0x495....7b5e'} />
            </Card>
            ...
            <Card
              ...
              actions={[
                <Tooltip title="View On Opensea">
                  <FileSearchOutlined
                    onClick={() =>
                      window.open("https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/45420177711653843954781376584544552839302508263742502603255103411916063637505", "_blank")
                    }
                  />
                </Tooltip>,
              ]}
